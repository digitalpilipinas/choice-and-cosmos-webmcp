...
- **Context.** Pick a horizon (daily Signal, weekly Compass, or yearly Constellation), name what's actually on your mind, and pick a tone. You may also enter self-supplied belief-system fields (western placements, numerology numbers, Chinese animal or element, BaZi Day Master, Human Design). Those fields stay absent unless you choose them. The app never infers them and never asks for a birth date, birth time, or birth location. This fixture loop still continues without a module.
